...
class XYZGenerator(nn.Module):
    ...
    def forward(self, psylink_data):
        psylink_data = self.fc1(psylink_data)
        psylink_data = nn.ReLU(psylink_data)
        psylink_data = self.fc2(psylink_data)
        psylink_data = nn.ReLU(psylink_data)
        psylink_data = self.fc3(psylink_data)
        psylink_data = nn.ReLU(psylink_data)
        psylink_data = self.fc4(psylink_data)
        psylink_data = nn.ReLU(psylink_data)
        psylink_data = self.dropout(psylink_data)
        psylink_data = self.fc5(psylink_data)
        psylink_data = nn.ReLU(psylink_data)
